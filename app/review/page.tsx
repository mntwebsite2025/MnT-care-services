...
function ReviewPageContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F0F9E8] to-[#E8F5E0] py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Help others by sharing your experience with MnT Care Service</p>
          </div>
          ...
          {leadDetails && (
            <Card className="mb-6 border-l-4 border-primary">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  <span className="font-medium">Service Enquiry:</span>
                  <span>{leadDetails.subject}</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-600">
